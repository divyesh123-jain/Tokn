...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      className={cn(
        "inline-flex items-center justify-center rounded-lg px-3 py-1.5 text-sm font-medium transition-all data-[state=active]:bg-card data-[state=active]:text-card-foreground",
        className,
      )}
      {...props}
    />
